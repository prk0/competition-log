...
| [M-02](#users-risk-losing-rewards-when-increasestake-or-decreasestake-is-called) | Users risk losing rewards when increaseStake() or decreaseStake() is called | 74 |
| [M-03](#fee-collection-for-gtelaunchpadv2pair-can-be-bricked) | Fee collection for GTELaunchpadV2Pair can be bricked | 41 | 
| [M-04](#arithmetic-overflows-underflows-are-not-correctly-handled-in-gtelaunchpadv2pair::update) | Arithmetic overflows / underflows are not correctly handled in GTELaunchpadV2Pair::_update() | 11 |
